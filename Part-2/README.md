# Python Homework - Part 2: Py Me Up, Charlie

## Background

Well... you've made it to the second leg of the assignment!

In part 2 of the homework, you'll be using the concepts you've learned to complete **2** Python Challenges, PyBank and PyPoll.
Both of these challenges encompasses a real-world situation where your newfound Python scripting skills can come in handy. These challenges are far from easy so expect some hard work ahead!

### Before You Begin

1. Create a new folder in your repository for this project called `python-challenge`.
...
4. Push the above changes your homework repository on  GitHub.
